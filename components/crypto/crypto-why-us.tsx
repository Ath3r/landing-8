...
const reasons = [
  {
    ...
    description: "Trade cryptocurrencies with confidence on our fully regulated and secure platform"
  },
  {
  ...
  },
  {
    ...
    title: "24/7 Trading",
    description: "Trade cryptocurrencies around the clock with our always-on platform"
  },
  {
    icon: <BookOpen className="w-8 h-8" />,
    title: "Expert Support",
    description: "Get help from our dedicated crypto trading experts whenever you need it"
  }
]
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Experience premium crypto trading conditions with our advanced platform
          </p>
        </motion.div>
