...
const reasons = [
  {
    ...
    title: "Major Indices",
    description:
      "Trade the world's most popular stock indices including S&P 500, NASDAQ, and more",
  },
  {
    icon: <Clock className="w-8 h-8" />,
    title: "Extended Hours",
    description:
      "Access markets during pre-market and after-hours trading sessions",
  },
  {
    icon: <Shield className="w-8 h-8" />,
    title: "Secure Broker",
    description: "Trade with confidence on our fully secure Broker",
  },
  {
