...
const reasons = [
  {
    ...
    description: "Trade with confidence on a regulated platform that prioritizes security and compliance"
  },
  {
    icon: <Clock4 className="w-8 h-8" />,
    title: "Extended Hours",
    description: "Maximize opportunities with flexible pre-market and after-hours trading sessions"
  },
  {
    icon: <BookOpen className="w-8 h-8" />,
    title: "Market Research",
    description: "Stay ahead with real-time analytics, comprehensive research, and market insights"
  },
  {
    icon: <HeartHandshake className="w-8 h-8" />,
    title: "Expert Support",
    description: "Get personalized guidance from our team of seasoned trading professionals"
  }
]

export function StocksWhyUs() {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Experience unparalleled trading excellence with a broker that puts your success first
          </p>
        </motion.div>
