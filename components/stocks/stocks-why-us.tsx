...
import { ShieldCheck, Clock4, BookOpen, HeartHandshake } from "lucide-react";
...
const reasons = [
  {
    ...
    description:
      "Trade with confidence on a platform that prioritizes security and compliance",
  },
  {
    icon: <Clock4 className="w-8 h-8" />,
    title: "Extended Hours",
    description:
      "Maximize opportunities with flexible pre-market and after-hours trading sessions",
  },
  {
    icon: <BookOpen className="w-8 h-8" />,
    title: "Market Research",
    description:
      "Stay ahead with real-time analytics, comprehensive research, and market insights",
  },
  {
    icon: <HeartHandshake className="w-8 h-8" />,
    title: "Expert Support",
    description:
      "Get personalized guidance from our team of seasoned trading professionals",
  },
];
